...
resource "aws_apigatewayv2_api" "demo_http" {
  ...
  tags = {
    # si tienes tags, los agregas aquí
  }

}
#TODO: https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/api_gateway_stage
# https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-stages.html
# 1. PR acceptada -> activa github action que crea zips i els guarda a S3
# 2. S3 event que actualitza lambdas quan es pujen codis. Event predefinit a terraform.
