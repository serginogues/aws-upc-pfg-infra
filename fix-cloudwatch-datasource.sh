...
echo -e "${GREEN}🔧 Fixing CloudWatch datasource configuration...${NC}"
...
# Fix CloudWatch datasource via SSH
echo -e "${YELLOW}🔧 Updating CloudWatch datasource...${NC}"
...
echo "CloudWatch datasource fix completed!"
EOF

echo -e "${GREEN}✅ CloudWatch datasource fixed!${NC}"
echo -e "${GREEN}🌐 Access Grafana at: http://$GRAFANA_IP:3000${NC}"
echo -e "${YELLOW}💡 The region should now be properly configured${NC}"
